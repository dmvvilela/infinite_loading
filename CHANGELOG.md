...
- Removed dependency on `simple_animations` package
- Replaced image assets with built-in Flutter icons
- Changed constructor parameters to use named optional parameters instead of `@required`

### New Features
- ✨ Complete rewrite with modern Flutter architecture
- 🎨 Fully customizable oscillating loading animation
- ⚡ Configurable animation speed via `oscillationDuration`
- 🎯 Configurable progress bar width via `progressBarWidth`
- 🖌️ Separate color controls for track, progress, and borders
